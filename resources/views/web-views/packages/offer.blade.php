                    ...
                    <div class="swiper-wrapper">
                        ...
                        {{-- <div class="swiper-slide">
                            <div class="wptb-packages1">
                                <div class="wptb-item--inner">
                                    <div class="wptb-item--holder">
                                        <h6 class="wptb-item--subtitle">Royal Package</h6>
                                        <h4 class="wptb-item--title">$35/<sub>session</sub></h4>
                                        <div class="wptb-list1">
                                            <!-- Item -->
                                            <div class="wptb--item">
                                                <div class="wptb-item--icon">âœ”</div>
                                                <div class="wptb-item--text">Candid Photography</div>
                                            </div>
                                            <div class="wptb--item">
                                                <div class="wptb-item--icon">âœ”</div>
                                                <div class="wptb-item--text">Traditional Photography</div>
                                            </div>
                                            <div class="wptb--item">
                                                <div class="wptb-item--icon">âœ”</div>
                                                <div class="wptb-item--text">180 page / 90 leaf photo album</div>
                                            </div>
                                            <div class="wptb--item">
                                                <div class="wptb-item--icon">âœ”</div>
                                                <div class="wptb-item--text">Matt/Glossy finish with 10 special paper
                                                    printing</div>
                                            </div>
                                            <div class="wptb--item">
                                                <div class="wptb-item--icon">âœ”</div>
                                                <div class="wptb-item--text">4 Photo Lamination</div>
                                            </div>
                                            <div class="wptb--item">
                                                <div class="wptb-item--icon">âœ”</div>
                                                <div class="wptb-item--text">Pre/Post Wedding Photos</div>
                                            </div>
                                            <div class="wptb--item">
                                                <div class="wptb-item--icon">âœ”</div>
                                                <div class="wptb-item--text">Candid Videography</div>
                                            </div>
                                            <div class="wptb--item">
                                                <div class="wptb-item--icon">âœ”</div>
                                                <div class="wptb-item--text">Traditional Videography</div>
                                            </div>
                                            <div class="wptb--item">
                                                <div class="wptb-item--icon">âœ”</div>
                                                <div class="wptb-item--text">Drone/Helicam Video</div>
                                            </div>
                                            <div class="wptb--item">
                                                <div class="wptb-item--icon">âœ”</div>
                                                <div class="wptb-item--text">Highlight Video</div>
                                            </div>
                                            <div class="wptb--item">
                                                <div class="wptb-item--icon">âœ”</div>
                                                <div class="wptb-item--text">HD Quality Video</div>
                                            </div>
                                            <div class="wptb--item">
                                                <div class="wptb-item--icon">âœ”</div>
                                                <div class="wptb-item--text">Pre/Post Wedding Video</div>
                                            </div>
                                            <div class="wptb--item">
                                                <div class="wptb-item--icon">âœ”</div>
                                                <div class="wptb-item--text">Wedding Reels</div>
                                            </div>
                                            <div class="wptb--item">
                                                <div class="wptb-item--icon">âœ”</div>
                                                <div class="wptb-item--text">Live Printing</div>
                                            </div>
                                            <div class="wptb--item">
                                                <div class="wptb-item--icon">âœ”</div>
                                                <div class="wptb-item--text">Minibook</div>
                                            </div>
                                            <div class="wptb--item">
                                                <div class="wptb-item--icon">âœ”</div>
                                                <div class="wptb-item--text">Face Recognized Photo Sharing</div>
                                            </div>
                                            <div class="wptb--item">
                                                <div class="wptb-item--icon">âœ”</div>
                                                <div class="wptb-item--text">Personalised Photo Gifts (2)</div>
                                            </div>
                                        </div>
                                        <div class="wptb-item--button my-3">
                                            <a class="btn gray creative" href="#">
                                                <div class="btn-wrap">
                                                    <span class="text-first"> Book Appointment </span>
                                                </div>
                                            </a>
                        ...
                        {{-- <div class="swiper-slide">
                            <div class="wptb-packages1">
                                <div class="wptb-item--inner">
                                    <div class="wptb-item--holder">
                                        <h6 class="wptb-item--subtitle">Star Package</h6>
                                        <h4 class="wptb-item--title">$1500/<sub>event</sub></h4>
                                        <div class="wptb-list1">
                                            <!-- Reuse the same SVG icon -->
                                            <!-- You can wrap this in a function/loop if templating -->
                                            <div class="wptb--item">
                                                <div class="wptb-item--icon">âœ”</div>
                                                <div class="wptb-item--text">Candid Photography</div>
                                            </div>
                                            ...
                                            <div class="wptb--item">
                                                <div class="wptb-item--icon">âœ”</div>
                                                <div class="wptb-item--text">140 Page / 70 Leaf Album</div>
                                            </div>
                                            <div class="wptb--item">
                                                <div class="wptb-item--icon">âœ”</div>
                                                <div class="wptb-item--text">Matt/Glossy Finish with 5 Special Paper Prints
                                                </div>
                                            </div>
                                            <div class="wptb--item">
                                                <div class="wptb-item--icon">âœ”</div>
                                                <div class="wptb-item--text">3 Photo Laminations</div>
                                            </div>
                                            <div class="wptb--item">
                                                <div class="wptb-item--icon">âœ”</div>
                                                <div class="wptb-item--text">Pre/Post Wedding Photos</div>
                                            ...
                                            <div class="wptb--item">
                                                <div class="wptb-item--icon">âœ”</div>
                                                <div class="wptb-item--text">Drone Video</div>
                                            </div>
                                            <div class="wptb--item">
                                                <div class="wptb-item--icon">âœ”</div>
                                                <div class="wptb-item--text">Highlight Video</div>
                                            ...
                                            <div class="wptb--item">
                                                <div class="wptb-item--icon">âœ”</div>
                                                <div class="wptb-item--text">Personalized Photo Gift (1)</div>
                                            </div>
                                        </div>
                                        <div class="wptb-item--button my-3">
                                            <a class="btn gray creative" href="#">
                        ...
                        {{-- <div class="swiper-slide">
                            <div class="wptb-packages1">
                                <div class="wptb-item--inner">
                                    <div class="wptb-item--holder">
                                        <h6 class="wptb-item--subtitle">Classic Package</h6>
                                        <h4 class="wptb-item--title">$XX/<sub>session</sub></h4>
                                        <!-- Add price -->
                                        <div class="wptb-list1">
                                            <!-- Replace these <div class="wptb--item"> blocks with features -->
                                            <div class="wptb--item">
                                                <div class="wptb-item--icon">âœ”</div>
                                                <div class="wptb-item--text">Traditional Photography</div>
                                            </div>
                                            <div class="wptb--item">
                                                <div class="wptb-item--icon">âœ”</div>
                                                <div class="wptb-item--text">80 Page / 40 Leaf Photo Album</div>
                                            </div>
                                            <div class="wptb--item">
                                                <div class="wptb-item--icon">âœ”</div>
                                                <div class="wptb-item--text">Matt/Glossy Finish Printing</div>
                                            </div>
                                            <div class="wptb--item">
                                                <div class="wptb-item--icon">âœ”</div>
                                                <div class="wptb-item--text">3 Photo Laminations</div>
                                            ...
                                            <div class="wptb--item">
                                                <div class="wptb-item--icon">âœ”</div>
                                                <div class="wptb-item--text">Pre-Wedding Photos</div>
                                            </div>
                                            <div class="wptb--item">
                                                <div class="wptb-item--icon">âœ”</div>
                                                <div class="wptb-item--text">Traditional Videography</div>
                                            ...
                                            <div class="wptb--item">
                                                <div class="wptb-item--icon">âœ”</div>
                                                <div class="wptb-item--text">Pre-Wedding Reels</div>
                                            </div>
                                            <div class="wptb--item">
                                                <div class="wptb-item--icon">âœ”</div>
                                                <div class="wptb-item--text">Minibook</div>
